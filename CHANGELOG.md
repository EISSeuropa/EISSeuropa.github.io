...
- **Accessibility statement refreshed for the June 2026 audit.** `/accessibility` (EN + FR + DE) now records the June 2026 site-wide WCAG 2.2 AA review (no critical or serious barriers), adds the accessible search dialog/combobox and the FR/DE `lang="en"` annotations to the implemented-features list, and documents two remaining keyboard gaps (the conference-film controls and mobile-menu Escape dismissal) as known limitations. Review date bumped to 2 June 2026. Per CLAUDE.md §9.
