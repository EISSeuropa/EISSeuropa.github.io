...
- **Symposium photo on `/coercion`.** The Coercive Statecraft Programme page (previously text-only) gains a photo in its Annual Symposium section. Sourced from a migrated-but-orphaned composite image in the repo (`1760518013943-1280x720.jpg`); the clean room photo was cropped out (dropping the baked-in COST logo, which the page doesn't reference) and web-optimised to `coercion-symposium.jpg` (1280×398, 78 KB).
