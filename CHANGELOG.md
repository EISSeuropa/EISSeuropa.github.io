...
- **Signposts now point to the "Conference Navigator".** The link-card on the conference programme pages and the People page, and the visual sitemap, used to offer separate "Speakers" and "Papers" destinations; they now name the unified Conference Navigator, matching the page itself. Wayfinding follow-on to the speaker and paper merge ([#756](https://github.com/EISSeuropa/EISSeuropa.github.io/issues/756)). EN + FR + DE.
