...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **13 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.23.1** (8 Added, 2 Changed, 2 Fixed, 1 Security). Last refresh by `scripts/sync-roadmap.py`: 28 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
