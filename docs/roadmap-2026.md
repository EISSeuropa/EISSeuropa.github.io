...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **40 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.27.0** (10 Added, 12 Changed, 18 Fixed). Last refresh by `scripts/sync-roadmap.py`: 22 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
