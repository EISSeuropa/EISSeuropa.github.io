...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **16 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.26.0** (16 Added). Last refresh by `scripts/sync-roadmap.py`: 1 Jul 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
