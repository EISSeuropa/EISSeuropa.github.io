...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **50 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.27.0** (14 Added, 14 Changed, 22 Fixed). Last refresh by `scripts/sync-roadmap.py`: 27 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
