...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **24 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.23.1** (10 Added, 7 Changed, 6 Fixed, 1 Security). Last refresh by `scripts/sync-roadmap.py`: 29 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
