...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **49 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.27.0** (13 Added, 14 Changed, 22 Fixed). Last refresh by `scripts/sync-roadmap.py`: 27 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
