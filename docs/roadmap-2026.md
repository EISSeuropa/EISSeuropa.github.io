...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **6 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.23.0** (4 Changed, 1 Removed, 1 Fixed). Last refresh by `scripts/sync-roadmap.py`: 26 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
