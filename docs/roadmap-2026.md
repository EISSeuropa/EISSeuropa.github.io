...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **23 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.28.0** (2 Added, 5 Changed, 1 Removed, 15 Fixed). Last refresh by `scripts/sync-roadmap.py`: 9 Sep 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
