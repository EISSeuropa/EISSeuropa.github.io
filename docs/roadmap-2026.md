...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **7 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.28.0** (1 Changed, 1 Removed, 5 Fixed). Last refresh by `scripts/sync-roadmap.py`: 2 Sep 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
