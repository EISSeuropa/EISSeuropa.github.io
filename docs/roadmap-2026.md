...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **10 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.25.0** (3 Added, 3 Changed, 4 Fixed). Last refresh by `scripts/sync-roadmap.py`: 11 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
