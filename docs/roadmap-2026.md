...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **30 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.24.0** (8 Added, 10 Changed, 1 Removed, 11 Fixed). Last refresh by `scripts/sync-roadmap.py`: 1 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
