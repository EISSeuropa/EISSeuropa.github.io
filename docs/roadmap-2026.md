...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **68 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.24.0** (13 Added, 26 Changed, 1 Removed, 28 Fixed). Last refresh by `scripts/sync-roadmap.py`: 5 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
