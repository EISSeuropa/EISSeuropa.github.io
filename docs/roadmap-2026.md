...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **1 entry** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.24.0** (1 Added). Last refresh by `scripts/sync-roadmap.py`: 30 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
