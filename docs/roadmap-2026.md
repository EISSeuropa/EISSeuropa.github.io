...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **7 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.24.0** (5 Added, 2 Fixed). Last refresh by `scripts/sync-roadmap.py`: 31 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
