...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **22 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.25.0** (6 Added, 9 Changed, 7 Fixed). Last refresh by `scripts/sync-roadmap.py`: 15 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
