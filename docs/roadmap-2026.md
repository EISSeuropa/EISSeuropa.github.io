...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **20 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.26.0** (19 Added, 1 Fixed). Last refresh by `scripts/sync-roadmap.py`: 20 Jul 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
