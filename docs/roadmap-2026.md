...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **70 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.26.0** (50 Added, 5 Changed, 15 Fixed). Last refresh by `scripts/sync-roadmap.py`: 17 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
