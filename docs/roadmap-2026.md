...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **41 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.24.0** (12 Added, 12 Changed, 1 Removed, 16 Fixed). Last refresh by `scripts/sync-roadmap.py`: 2 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
