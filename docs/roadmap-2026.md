...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **72 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.24.0** (15 Added, 27 Changed, 1 Removed, 29 Fixed). Last refresh by `scripts/sync-roadmap.py`: 8 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
