...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **25 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.28.0** (2 Added, 6 Changed, 1 Removed, 16 Fixed). Last refresh by `scripts/sync-roadmap.py`: 24 Sep 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
