...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **56 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.24.0** (12 Added, 22 Changed, 1 Removed, 21 Fixed). Last refresh by `scripts/sync-roadmap.py`: 4 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
