...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **16 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.23.1** (9 Added, 2 Changed, 4 Fixed, 1 Security). Last refresh by `scripts/sync-roadmap.py`: 28 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
