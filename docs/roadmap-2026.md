...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **4 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.25.0** (1 Added, 1 Changed, 2 Fixed). Last refresh by `scripts/sync-roadmap.py`: 9 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
