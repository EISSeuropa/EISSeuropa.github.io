...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **21 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.25.0** (7 Added, 7 Changed, 7 Fixed). Last refresh by `scripts/sync-roadmap.py`: 12 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
