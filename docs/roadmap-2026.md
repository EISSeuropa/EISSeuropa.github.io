...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **39 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.26.0** (36 Added, 2 Changed, 1 Fixed). Last refresh by `scripts/sync-roadmap.py`: 3 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
