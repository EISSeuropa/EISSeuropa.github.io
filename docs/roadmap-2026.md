...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **13 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.25.0** (4 Added, 4 Changed, 5 Fixed). Last refresh by `scripts/sync-roadmap.py`: 11 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
