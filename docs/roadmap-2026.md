...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **56 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.26.0** (47 Added, 3 Changed, 6 Fixed). Last refresh by `scripts/sync-roadmap.py`: 8 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
