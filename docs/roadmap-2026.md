...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **82 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.26.0** (54 Added, 10 Changed, 18 Fixed). Last refresh by `scripts/sync-roadmap.py`: 19 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
