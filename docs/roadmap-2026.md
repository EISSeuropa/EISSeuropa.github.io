...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **40 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.25.0** (1 Added, 26 Changed, 13 Fixed). Last refresh by `scripts/sync-roadmap.py`: 19 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
