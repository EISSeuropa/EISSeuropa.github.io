...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **6 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.27.0** (2 Changed, 4 Fixed). Last refresh by `scripts/sync-roadmap.py`: 20 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
