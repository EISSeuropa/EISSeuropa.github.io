...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **65 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.26.0** (50 Added, 4 Changed, 11 Fixed). Last refresh by `scripts/sync-roadmap.py`: 9 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
