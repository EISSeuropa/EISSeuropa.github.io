...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **34 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.27.0** (9 Added, 9 Changed, 16 Fixed). Last refresh by `scripts/sync-roadmap.py`: 21 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
