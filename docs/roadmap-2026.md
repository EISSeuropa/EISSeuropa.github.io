...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **42 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v2.27.0** (10 Added, 12 Changed, 20 Fixed). Last refresh by `scripts/sync-roadmap.py`: 23 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
