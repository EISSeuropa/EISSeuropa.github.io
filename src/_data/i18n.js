...
const locales = {
  en: {
    ...
    prizes: {
      eyebrow: "Recognition",
      title: "Prizes",
      lead: "The prizes the EISS community awards, and the roll of laureates.",
      bestPaperHeading: "Early-Career Researcher Best Paper Prize",
      bestPaperIntro: "Awarded each year at the conference, in partnership with the Journal of Strategic Studies, for the best paper by an early-career researcher. Each laureate's paper sits in the Anthology, with its abstract, published version and citation.",
      readEntry: "Read in the Anthology",
      irondelleHeading: "Prix Bastien Irondelle",
      irondelleIntro: "The network's prize for the best doctoral paper. Its roll of laureates is being compiled with the board and will appear here.",
    },
  ...
  fr: {
    ...
    prizes: {
      ...
      title: "Prix",
      lead: "Les prix décernés par la communauté EISS, et le palmarès des lauréats.",
      bestPaperHeading: "Prix du meilleur article pour jeunes chercheurs",
      bestPaperIntro: "Décerné chaque année lors de la conférence, en partenariat avec le Journal of Strategic Studies, pour le meilleur article d'un jeune chercheur. L'article de chaque lauréat figure dans l'Anthologie, avec son résumé, sa version publiée et sa citation.",
      readEntry: "Lire dans l'Anthologie",
      irondelleHeading: "Prix Bastien Irondelle",
      irondelleIntro: "Le prix du réseau récompensant le meilleur article doctoral. Son palmarès est en cours de compilation avec le bureau et sera publié ici.",
    },
    name: "French",
    htmlLang: "fr",
  ...
  de: {
    ...
    prizes: {
      ...
      title: "Preise",
      lead: "Die von der EISS-Gemeinschaft vergebenen Preise und die Liste der Preisträger.",
      bestPaperHeading: "Best Paper Prize für Nachwuchswissenschaftler",
      bestPaperIntro: "Jährlich auf der Konferenz verliehen, in Partnerschaft mit dem Journal of Strategic Studies, für den besten Beitrag einer Nachwuchswissenschaftlerin oder eines Nachwuchswissenschaftlers. Der Beitrag jedes Preisträgers steht in der Anthologie, mit Abstract, veröffentlichter Fassung und Zitation.",
      readEntry: "In der Anthologie lesen",
      irondelleHeading: "Prix Bastien Irondelle",
      irondelleIntro: "Der Preis des Netzwerks für den besten Doktorandenbeitrag. Die Preisträgerliste wird mit dem Vorstand zusammengestellt und hier veröffentlicht.",
    },
    name: "German",
    htmlLang: "de",
