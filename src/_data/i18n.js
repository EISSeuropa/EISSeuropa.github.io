...
const locales = {
  en: {
    ...
    atlas: {
      ...
      matrixCell: "{a} and {b}, {n} papers",
      matrixSelf: "{name}, {n} papers in total",
      matrixNote: "Each cell counts the papers two themes both tag, and opens them on the map. The diagonal is a theme's own total. A paper carries a theme when its panel or its abstract matches it, so a pair reads as two fields meeting in one room rather than as a claim about a paper's subject.",
    ...
    navigator: {
      ...
      renewalNote: "First time means a first appearance anywhere in this corpus, joint events included, rather than a first conference paper. The opening edition is 100% by definition. Names are matched conservatively, so one person spelled two ways counts as two, which can only push the first-time share up.",
  ...
  fr: {
    ...
    atlas: {
      ...
      matrixCell: "{a} et {b}, {n} communications",
      matrixSelf: "{name}, {n} communications au total",
      matrixNote: "Chaque case compte les communications que deux thèmes marquent ensemble et les ouvre sur la carte. La diagonale donne le total propre à chaque thème. Un thème est attribué lorsque le panel ou le résumé y correspond : une paire signale donc deux champs réunis dans une même salle, et non une affirmation sur le sujet d'une communication.",
    ...
    navigator: {
      ...
      renewalColNew: "Première fois",
      renewalColSolo: "Auteur unique",
      renewalColPerPaper: "Auteurs par communication",
      renewalNote: "« Première fois » désigne une première apparition dans ce corpus, événements conjoints compris, et non une première communication en colloque. L'édition inaugurale atteint 100 % par construction. Le rapprochement des noms reste prudent : une même personne orthographiée de deux façons compte double, ce qui ne peut que gonfler la part des primo-participants.",
  ...
  de: {
    ...
    atlas: {
      ...
      matrixCell: "{a} und {b}, {n} Beiträge",
      matrixSelf: "{name}, {n} Beiträge insgesamt",
      matrixNote: "Jede Zelle zählt die Beiträge, die zwei Themen gemeinsam tragen, und öffnet sie auf der Karte. Die Diagonale zeigt die Gesamtzahl eines Themas. Ein Thema wird vergeben, wenn das Panel oder das Abstract dazu passt. Ein Paar bedeutet also, dass sich zwei Felder in einem Raum begegnet sind, und keine Aussage über das Thema eines einzelnen Beitrags.",
    ...
    navigator: {
      ...
      renewalColNew: "Erstmals",
      renewalColSolo: "Alleinautorschaft",
      renewalColPerPaper: "Autoren pro Beitrag",
      renewalNote: "„Erstmals“ bezeichnet das erste Auftreten in diesem Korpus, gemeinsame Veranstaltungen eingeschlossen, nicht den ersten Konferenzbeitrag überhaupt. Die erste Ausgabe erreicht zwangsläufig 100 %. Namen werden zurückhaltend zusammengeführt, sodass eine Person in zwei Schreibweisen doppelt zählt, was den Anteil der Erstteilnehmenden nur erhöhen kann.",
